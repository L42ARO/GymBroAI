...
# class Exercise:
#     def __init__(self, name: str, difficulty: ExerciseDifficulty, 
#                  bodyareas: list[ExerciseBodyArea], sets: list[Set]):
#         self.name: str = name
#         self.bodyarea: list[ExerciseBodyArea] = bodyareas
#         self.difficulty: ExerciseDifficulty = difficulty
...
class Set(BaseModel):
    ...
    time: float = Field("How long to perform this exercise for, if applicable. If it's a rep-based exercise, \
                        set this field to 0.")
